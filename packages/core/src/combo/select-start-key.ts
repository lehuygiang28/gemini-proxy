...
export function selectStartKey(input: {
    ...
    if (input.strategy === 'sticky_until_error' && !shouldRotate) {
...
function compareKeys(
    ...
    if (left.lastUsedAt != null && right.lastUsedAt != null && left.lastUsedAt !== right.lastUsedAt) {
